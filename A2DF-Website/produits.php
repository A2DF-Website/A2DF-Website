                                    ...
                                    <div class = 'row'>
                                        ...
                                        foreach ($magasin->produits->produit as $produit) {
                                            ...
                                            if ($type == $i) {
                                                ...
                                                ?>          <a href="details.php?id=<?= $idProduit ?>"><img class='img-responsive img-hover center-block' src='http://gestinter.a2dfinformatique.com/produits/<?= $image ?>' onError="this.onerror=null;this.src='../A2DF/produits/notfound.png';" style="max-height: 170px;"></a><?php
                                                echo "      </div>";
