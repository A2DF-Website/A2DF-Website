    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Professionnels</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="text-center">
                <p><h4>
                    A2DF Informatique vous propose un Contrat de Maintenance afin de garantir des interventions rapides - entre 24 et 48 h - et efficaces !
                </h4>    </p>
            </div>
            </br>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <img class="img-responsive" src="img/professionnel.jpg" alt="">
            </div>
        </div>
        <!-- /.row -->
